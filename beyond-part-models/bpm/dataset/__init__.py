...
def create_dataset(
  ...
  if name == 'market1501':
    ...
    im_dir = ospeu('./dataset/synthetic/market/images')
    partition_file = ospeu('./dataset/synthetic/market/partitions.pkl')
    ...
    im_dir = ospeu('./dataset/synthetic/duke/images')
    partition_file = ospeu('../dataset/synthetic/duke/partitions.pkl')
